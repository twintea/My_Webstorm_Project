import { listShopInterfaceInfoVOByPageUsingPOST } from '@/services/twintea-api-backend/interfaceInfoController';
import { addUserInterfaceInfoUsingPOST } from '@/services/twintea-api-backend/userInterfaceInfoController';
...
const Index: React.FC = () => {
    ...
    const loadData = async (searchText = '', current = 1, pageSize = 10) => {
        setLoading(true);
        try {
            await listShopInterfaceInfoVOByPageUsingPOST({
                searchText,
                current,
                pageSize,
            }).then((res) => {
