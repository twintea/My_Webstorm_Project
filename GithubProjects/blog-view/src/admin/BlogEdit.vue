    ...
    <div class="m-content">
      ...
      <el-form ref="ruleForm" :model="ruleForm" :rules="rules" class="demo-ruleForm" label-position="top"
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="文章首图URL" prop="thumbnail">
              <el-input v-model="ruleForm.thumbnail" placeholder="文章首图，可为空"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <!--文章描述-->
        <el-form-item label="文章描述" prop="summary">
          <mavon-editor @dblclick.native="autoWrite" v-model="ruleForm.summary"/>
        </el-form-item>
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="分类" prop="cate">
              <el-select v-model="ruleForm.categoryId" :allow-create="true" :filterable="true" placeholder="请选择分类（输入可添加新分类）" style="width: 100%;">
...
<!--            </el-form-item>-->
          ...
          <el-col :span="12">
            <el-form-item label="浏览次数" prop="viewCount">
              <el-input v-model="ruleForm.viewCount" placeholder="请输入文章字数（可选）默认为 0" type="number"></el-input>
            </el-form-item>
          </el-col>
          <!--是否公开-->
          <el-col :span="12">
...
<!--          是否置顶-->
        <el-col :span="12">
          <el-form-item label="是否置顶" prop="isTop">
            <el-tooltip :content="'Switch value: ' + ruleForm.isTop" placement="top">
  ...
  methods: {
    ...
    autoWrite() {
      if(this.ruleForm.content.length<100){
        this.ruleForm.summary = this.ruleForm.content.substring(0,this.ruleForm.content.length)
      }
      else{
        this.ruleForm.summary = this.ruleForm.content.substring(0,100)
      }
    },
    //双击将计算正文内容的字数
    // computeWords() {
    ...
    getBlogById() {
      ...
      if (blogId) {
        this.$axios.get('/blog/detail/' + blogId).then(res => {
          ...
          _this.ruleForm.thumbnail = blog.thumbnail
          _this.ruleForm.summary = blog.summary
          _this.ruleForm.content = blog.content
          // _this.ruleForm.words = blog.words
          _this.ruleForm.viewCount = blog.viewCount
          _this.ruleForm.categoryId = blog.categoryId
          _this.ruleForm.status = blog.status
          _this.ruleForm.isTop = blog.isTop
          _this.ruleForm.createBy = blog.createBy
