  ...
  <div class="header-container">
    <div class="wrapper">
      ...
      <div class="left-wrapper v-link selected">
        <img style="width: 50px" width="50" height="50" src="~assets/images/hospital.png">
        <span class="text" @click="backToIndex">全国 预约挂号统一平台</span>
      </div>
      <!-- 搜索框 -->
        ...
        <div class="info-wrapper">
          <div class="code-wrapper">
            ...
            <div class="wechat-code-wrapper"><img
              ...
              class="code-img">
              <div class="code-text"> 扫一扫</div>
              <div class="code-text"> “预约挂号”</div>
            </div>
          </div>
          <div class="slogan">
            <div>指定平台</div>
...
export default {
  ...
  methods: {
    ...
    // 获取验证码
    getCodeFun() {
      if (!(/^([A-z0-9]{6,18})(\w|\-)+@[A-z0-9]+\.([A-z]{2,3})$/.test(this.userInfo.email))) {
        this.$message.error('邮箱号码不正确')
        return;
      }
      ...
      smsApi.sendCode(this.userInfo.email).then(response => {
        this.timeDown();
      }).catch(e => {
